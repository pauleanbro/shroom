...
export interface IFurnitureData {
    ...
    getTypeById(id: FurnitureId, type: "wall" | "floor"): Promise<string | undefined>;
...
export type FurnitureInfo = {
    [key in keyof typeof furnitureDataTransformers]: ReturnType<typeof furnitureDataTransformers[key]>;
};
