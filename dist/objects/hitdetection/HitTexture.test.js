...
const HitTexture_1 = require("./HitTexture");
// To view this image, just copy it and use it as a url in your browser
const testImage = "data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAIAAAACAQMAAABIeJ9nAAAAAXNSR0IB2cksfwAAAAlwSFlzAAALEwAACxMBAJqcGAAAAAZQTFRF/wAAAAAAQaMSAwAAAAJ0Uk5T/wDltzBKAAAADElEQVR4nGNwYGgAAAFEAME6ehxWAAAAAElFTkSuQmCC";
test("detects first pixel", async () => {
    const texture = await HitTexture_1.HitTexture.fromUrl(testImage);
